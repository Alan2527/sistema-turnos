	...
	$sql .= " date_at = \"".$_GET["date_at"]."\"";
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<a href="https://api.whatsapp.com/send?phone=54<?php echo $pacient->phone;?>&text=Buenos días, este es un recordatorio para el turno de mañana con el Doctor Ruben Forte" class="btn btn-success btn-xs" target="_blank">Mensaje</a>
